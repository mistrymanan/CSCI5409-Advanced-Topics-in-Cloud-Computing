...
public class GatekeeperController {
    ...
    public ResponseEntity<?> userInfo(@RequestBody UserInfoRequest userInfoRequest){
        return gatekeeperService.getTemperature(userInfoRequest);
    }

    @PostMapping("/store-file")
    public ResponseEntity<?> storeFile(@RequestBody UserInfoRequest userInfoRequest){
        return gatekeeperService.storeFile(userInfoRequest);
    }
}
